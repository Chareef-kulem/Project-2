...
=======
    <nav className=" border-gray-200  sm:px-4 py-4  bg-darkbg relative cursor-default font-['Itim'] ">
>>>>>>> de4e81e (testform)
    ...
    <div className=" flex ">
        ...
        <div>
        <p className="self-center lg:text-xl font-semibold whitespace-nowrap  sm: text-sm">Let us help you</p>
...
>>>>>>> de4e81e (testform)
  ...
  <Transition
          ...
          leaveTo="opacity-0"
            ...
            <div
              ref={ref}
              className=" bg-darkbg  space-y-1 sm:px-4 sm:py-5 text-black"
            >
             {MENUS.map((menu) => (
          <Link key={menu.href} href={menu.href}>
            <a
